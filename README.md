...
3. Create the KNIME workspaces folder and prepare at least one workspace folder to be used for the running container
    ...
    - as for the individual KNIME workspace folder, the easiest way to use the KNIME and our KNIME metanodes and workflows ecosystem is to use preset KNIME workspace folder provided in this repository in the form of its zip archive - [knime-workspace_4-7-7a.zip](https://github.com/OmicsWorkflows/KNIME_docker_vnc/blob/master/knime-workspace_4-7-7a.zip)
